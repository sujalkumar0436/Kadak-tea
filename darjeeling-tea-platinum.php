  ...
  <body>
   ...
   ?>
    ...
    <section id="product-details">
      ...
      <div class="single-pro-details">
        <h6><a href="index.php">Home</a>/<a href="shop.php">Shirts</a></h6>
      ...
      <div class="pro-container">
        ...
        <div class="pro">
          <img
            ...
            alt=""
            onclick="window.location.href='darjeeling-tea-royale.php';"
          />
          <div class="dis">
            <span>Kadak</span>
            <h5>Lorem ipsum dolor sit amet.</h5>
   ...
   <ul>
      ...
      <div class="col">
        <h4>My Account</h4>
        <p>
          <a href="signup/index.php" style="text-decoration: none">Sign In</a>
        </p>
        <p>View Cart</p>
        <p>Track My Order</p>
        <p>help</p>
    ...
    <script>
      ...
      smallImg4.addEventListener("click", () => {
        mainImg.src = "https://i.ibb.co/bH7kSqx/f4.jpg";
      });
    </script>
