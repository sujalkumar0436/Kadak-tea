...
<html lang="en">
  ...
  <body>
   ...
   ?>
          ...
          <li><a href="cart.php" id="lg-bag"><i class="fa-solid fa-cart-shopping"></i></a><span id="cart-item">0</span></li>
          <a href="#" id="close"><i class="fa-solid fa-xmark"></i></a>
        </ul>
      </nav>
      <div id="mobile">
        <a href="cart.php" id="cart"><i class="fa-solid fa-cart-shopping fa-xxl"></i></a>
    ...
    <section id="newsletter" class="">
      <div class="newsText">
        ...
        <h2>Get Email Updates about Our Latest Kadak</h2>
      </div>
      <div class="form">
   ...
   <ul>
      ...
      <div class="col">
        <h4>My Account</h4>
        <p><a href="signup/index.php" style="text-decoration: none;">Sign In</a></p>
        <p>View Cart</p>
        <p>Track My Order</p>
        <p>help</p>
      </div>
